...
[0-9]+		{ return token(INT_LITERAL); } // regex matching any integer

// regex matching strings such as "hello" or "world"
// a " followed by anything except another " or \n 0 or more times, ending with a "
\"[^\"\n]*\"		{ return token(STRING_LITERAL, yytext().substring(1, yytext().length() - 1)); } 

{WhiteSpace} {} // return nothing for whitespace
